...
class Settings:
    ...
    RETENTION_FAILED_DAYS = int(os.getenv("DOCURAPI_RETENTION_FAILED_DAYS", "7"))
    RETENTION_UNPAID_DAYS = int(os.getenv("DOCURAPI_RETENTION_UNPAID_DAYS", "3"))
    RETENTION_REJECTED_DAYS = int(os.getenv("DOCURAPI_RETENTION_REJECTED_DAYS", "7"))
    RETENTION_EXPIRED_DAYS = int(os.getenv("DOCURAPI_RETENTION_EXPIRED_DAYS", "3"))
    RETENTION_AUDIT_LOG_DAYS = int(os.getenv("DOCURAPI_RETENTION_AUDIT_LOG_DAYS", "90"))
